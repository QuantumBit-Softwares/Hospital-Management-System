...
<div class="animate three" style="width:1600px; margin:0 auto;">
      ...
      <span>D</span><span>o</span><span>c</span><span>t</span><span>o</span><span>r</span><span></span> <span>E</span><span>m</span><span>a</span><span>i</span><span>l</span><span></span>&nbsp;
      by wecare4u.tk



<input type="text" id="myInput" onkeyup="myFunction()" placeholder="Search for doctor email.." title="Type in a number">
...
function myFunction() {
  ...
  //key is 'filter'
     ...
     //assigning first value to txtValue and txtValue1 AND td and td1
       ...
       td = tr[i].getElementsByTagName("td")[2]; //search input by user (choose from one, two, three, four, four)

       td1 = tr[i].getElementsByTagName("td")[3];  //search input by user (choose 1, 2, 3, 4, 4)

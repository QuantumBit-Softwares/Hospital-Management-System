...
//access then display to table
    ...
    global $con;
    //sort
    $query = "select * from patreg ORDER BY email";
...
function myFunction() {
  ...
  //key is 'filter'
     ...
     //assigning first value to txtValue and txtValue1 AND td and td1
       ...
       td = tr[i].getElementsByTagName("td")[4]; //search input by user (choose from one, two, three, four, four)

       td1 = tr[i].getElementsByTagName("td")[4];  //search input by user (choose 1, 2, 3, 4, 4)

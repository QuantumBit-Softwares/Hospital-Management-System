...
if(isset($_POST['patsub1'])){
  ...
  if($password==$cpassword){
  	//$query="insert into patreg(fname,lname,gender,email,contact,password,cpassword,patAddress) values ('$fname','$lname','$gender','$email','$contact','$password','$cpassword', '$patAddress');";
    $query="insert into patreg(fname,lname,gender,email,contact,password,cpassword,patAddress) values ('$fname','$lname','$gender','$email','$contact','$password','$cpassword', '$patAddress');";

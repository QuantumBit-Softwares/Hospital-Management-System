...
<input type="text" id="myInput" onkeyup="myFunction()" placeholder="Search for patient first names.." title="Type in a number">
...
//access then display to table
    ...
    global $con;
    //sort
    $query = "select * from patreg ORDER BY fname";

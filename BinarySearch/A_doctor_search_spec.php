...
<div class="animate three" style="width:1600px; margin:0 auto;">
      ...
      <span>D</span><span>o</span><span>c</span><span>t</span><span>o</span><span>r</span><span></span> <span>D</span><span>e</span><span>p</span><span>t</span>&nbsp;
      by wecare4u.tk



<input type="text" id="myInput" onkeyup="myFunction()" placeholder="Search for doctor department.." title="Type in a department">
...
//access then display to table
    ...
    global $con;
    //sort
    $query = "select * from doctb ORDER BY spec";
...
function myFunction() {
  ...
  //key is 'filter'
     ...
     //assigning first value to txtValue and txtValue1 AND td and td1
       ...
       td = tr[i].getElementsByTagName("td")[1]; //search input by user (choose from one, two, three, four, four)

       td1 = tr[i].getElementsByTagName("td")[2];  //search input by user (choose 1, 2, 3, 4, 4)

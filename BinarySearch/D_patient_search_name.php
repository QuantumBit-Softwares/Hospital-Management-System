...
<div class="animate three" style="width:1600px; margin:0 auto;">
      ...
      <span>Doctor's First Name</span>&nbsp;
      by wecare4u.tk



<input type="text" id="myInput" onkeyup="myFunction()" placeholder="Search for patient first name.." title="Type in a number">
...
$query = "select * from appointmenttb  where doctor = '$doctor' ORDER BY fname ; ";

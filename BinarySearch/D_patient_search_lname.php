...
<input type="text" id="myInput" onkeyup="myFunction()" placeholder="Search for patient last name.." title="Type in a number">
...
$query = "select * from appointmenttb  where doctor = '$doctor' ORDER BY lname ; ";
...
function myFunction() {
  ...
  //key is 'filter'
     ...
     //assigning first value to txtValue and txtValue1 AND td and td1
       ...
       td = tr[i].getElementsByTagName("td")[3]; //search input by user (choose from one, two, three, four, four)
